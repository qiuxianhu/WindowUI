...
namespace ImageCrop
{
    public partial class Form1 : Form
    {
        ...
        private void Upload(object sender, EventArgs e)
        {
            ...
            //绘制圆形头像
            _endPic.Size = new Size(100, 100);
            _endPic.Region = ImageOperate.DrawingCircle(_endPic.ClientRectangle);
            _endPic.Image = ImageOperate.AdjImageToFitSize(Image.FromFile(openDlg.FileName), 100, 100);
        }
        #endregion
